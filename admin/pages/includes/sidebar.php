    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="../addproduct" class="nav-link <?php echo $name == 'product' ? 'active': '' ?>">
              <i class="fas fa-users-cog nav-icon"></i>
              <p>Add product</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="../categlog" class="nav-link <?php echo $name == 'categlog' ? 'active': '' ?>">
            <i class="fas fa-cart-plus nav-icon"></i>
              <p>Categlog</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="../confirm" class="nav-link <?php echo $name == 'confirm' ? 'active': '' ?>">
