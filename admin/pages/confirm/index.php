...
$sql = "SELECT * FROM reserve AS t1 INNER JOIN slip AS t2 ON(t1.car_id=t2.order_id) INNER JOIN model AS t3 ON(t1.car_id=t3.id) ";
              ...
              <tr>
                ...
                <!-- <td>
                  ...
                  <td style="text-align: center;">
                    <?php if($row['status'] == 'w'){ ?>
                      <button class="btn btn-success" data-bs-target="#showForm<?php echo $num; ?>" data-bs-toggle="modal">Approve</button>
                        <div class="modal fade" id="showForm<?php echo $num; ?>">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">อนุมัติคำสั่งซื้อ</h4>
                                    ...
                                    <div class="modal-footer">
                                      ...
                                      <form action="db_confirm.php" method="POST">
                                        ...
                                        <button type="submit" id="submit" name="approve" value="1" class="btn btn-sm btn-success btn-block mb-2"><i class="fas fa-check"></i> ยืนยัน</button>
                                      </form>
                                    </div>
                                </div>
                            </div>
                        ...
                        <br>
                      <button class="btn btn-danger mt-2" data-bs-target="#showFormRe<?php echo $num; ?>" data-bs-toggle="modal">Reject</button>
